...
func (r *Reconciler) getOSData(ctx context.Context, cluster *kubermaticv1.Cluster) (*openshiftData, error) {
	...
	return &openshiftData{
		...
		backupS3Endpoint:                      r.backupS3Endpoint,
		backupS3BucketName:                    r.backupS3BucketName,
		backupS3AccessKeyID:                   r.backupS3AccessKeyID,
		backupS3SecretAccessKey:               r.backupS3SecretAccessKey,
