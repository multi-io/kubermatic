...
type controllerRunOptions struct {
	...
	clusterComponentsSettings                        string
...
func newControllerRunOptions() (controllerRunOptions, error) {
	...
	flag.StringVar(&c.clusterComponentsSettings, "default-cluster-overrides", "default-cluster-overrides", "Default components settings applied for every new cluster")
